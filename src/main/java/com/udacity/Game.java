...
public class Game {
    ...
    public String checkGameWinner(char [][]grid) {
        ...
        for (int i = 0; i < 3; i++) {
            if ((grid[i][0] == 'x') && ('x' == grid[i][1]) && (grid[i][2] == 'x')) {
                result = "X wins";
            } else if ((grid[i][0] == 'o') && ('o' == grid[i][1]) && (grid[i][2] == 'o')) {
                result = "O wins";
            }
        }
        for (int j = 0; j < 3; j++) {
            if ((grid[0][j] == 'x') && ('x' == grid[1][j]) && (grid[2][j] == 'x')) {
                result = "X wins";
            } else if ((grid[0][j] == 'o') && ('o' == grid[1][j]) && (grid[2][j] == 'o')) {
                result = "O wins";
            } else if ((grid[0][0] == 'x') && ('x' == grid[1][1]) && (grid[2][2] == 'x')) {
                result = "X wins";
            } else if ((grid[0][0] == 'o') && ('o' == grid[1][1]) && (grid[2][2] == 'o')) {
                result = "O wins";
            } else if ((grid[2][0] == 'x') && ('x' == grid[1][1]) && (grid[0][2] == 'x')) {
                result = "X wins";
            } else if ((grid[2][0] == 'o') && ('o' == grid[1][1]) && (grid[0][2] == 'o')) {
                result = "O wins";
            } else if (freeSpots == 0) {
                result = "Tie";
            }
